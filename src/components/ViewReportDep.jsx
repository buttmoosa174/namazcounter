...
export default function ViewReportDep() {
  ...
  return (
    <View className='flex-1 bg-white'>
      ...
      <Text className='text-center text-2xl font-bold my-3'>Prayers Report</Text>
      ...
      <View className='mx-4'>
        <Text className='mb-1 ml-1'>Search By Month:</Text>
      </View>
