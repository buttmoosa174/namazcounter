...
export default function ViewAllReport() {
  ...
  return (
    <View className='flex-1 bg-white'>
      ...
      <Text className='text-center text-2xl font-bold my-3'>Prayers Percentage Report</Text>
      ...
      <View className='mx-4 mb-1'>
        <Text className='ml-1'>Search By Month:</Text>
      </View>
      <View className='items-center justify-between flex-row mx-4 mb-4 bg-white border border-gray-400 rounded-lg p-2'>
        ...
        {/* <TouchableOpacity className='bg-indigo-700 rounded-full'>
          <Text className='text-white p-3'>Search</Text>
        </TouchableOpacity> */}
      </View>
