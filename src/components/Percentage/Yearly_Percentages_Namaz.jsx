...
export default function Yearly_Percentages_Namaz() {
    ...
    return (
        <View>
            <Text className='mx-5 text-[20px] font-bold text-center'>Prayer Percentage for the Current Year</Text>
                            ...
                            <View key={index}>
                                <View className='flex-row justify-evenly p-2 mx-5 my-2 items-center rounded-lg bg-gray-100'>
                                    ...
                                    <View className='w-[33%] h-[45px] justify-center text-wrap'>
                                        <Text className='text-[13px] text-wrap font-bold'>{dept.ClassPercentage}%</Text>
                                    </View>
